...
<body  style="overflow-x: hidden; direction: rtl" class="ar">
    ...
    <nav class="pos-f js-watch-state about" data-state="" data-active="on" data-page-scrolled="">
        <a href="javascript:;" class="logo logo-shield-wrap scroll-arrow" data-target="page-content"  style="width:180px">
            <img alt="medians ps system" width="100" class="mx-auto" height="79" src="../assets/whitelogo.webp" style="width:100px">
        </a>
        ...
        <div class="nav-contact flex">
            ...
            <a class=" px-2 mx-2 border-l-1 border-gray-100" href="/" title="English"><img alt="language" width="16" height="16" src="../assets/internet.webp" /></a>
            <a target="_blank" title="صفحتنا على الفيس بوك"  class=" px-1  border-l-1 border-gray-100" href="https://www.facebook.com/MediansPSsystem/"><img alt="language" width="16" height="16" src="../assets/facebook.webp" /></a>
        </div>
